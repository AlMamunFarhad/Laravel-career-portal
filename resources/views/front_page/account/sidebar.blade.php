...
<div class="card border-0 shadow mb-4 p-3">
    <div class="s-body text-center mt-3">
        @if (Auth::user()->image != '')
            <img src="{{ asset('/profile_img/thumb/' . Auth::user()->image) }}" alt="avatar"
                class="rounded-circle img-fluid img-responsive" style="width: 120px; height: 120px">
        @else
            <img src="{{ asset('assets/images/avatar7.png') }}" alt="avatar"
                class="rounded-circle img-fluid img-responsive" style="width: 150px; height: 150px">
        @endif
