                            ...
                            <div class="card-body card-form p-4">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-4">
                                        ...
                                        <input type="text" placeholder="Job Title" id="title" name="title"
                                            class="form-control" value="{{ $updateJob->title }}">
                                        <p></p>
                                    </div>
                                    <div class="col-md-6  mb-4">
                                        ...
                                        <select name="category" id="category" class="form-control">
                                            ...
                                            @if ($categories->isNotEmpty())
                                                @foreach ($categories as $category)
                                                    <option {{ $updateJob->category_id == $category->id ? 'selected' : '' }}
                                ...
                                <div class="row">
                                        ...
                                        <select class="form-select" name="jobType" id="jobType">
                                            ...
                                            @if ($jobTypes->isNotEmpty())
                                                @foreach ($jobTypes as $jobType)
                                                    <option {{ $updateJob->job_type_id == $jobType->id ? 'selected' : '' }}
                                    ...
                                    <div class="col-md-6  mb-4">
                                        ...
                                        <input type="number" min="1" placeholder="Vacancy" id="vacancy"
                                            name="vacancy" class="form-control" value="{{ $updateJob->vacancy }}">
                                        <p></p>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="mb-4 col-md-6">
                                        ...
                                        <input type="text" placeholder="Salary" id="salary" name="salary"
                                            class="form-control" value="{{ $updateJob->salary }}">
                                    ...
                                    <div class="mb-4 col-md-6">
                                        ...
                                        <input type="text" placeholder="location" id="location" name="location"
                                            class="form-control" value="{{ $updateJob->location }}">
                                        <p></p>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-check mb-4 col-md-6">
                                            <input class="form-check-input" type="checkbox" value="1" id="isFeatured"
                                                name="isFeatured" {{ ($updateJob->isFeatured == 1 ) ? 'checked' : '' }}>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-check-inline mb-4">
                                            <input class="form-check-input" type="radio" name="status" id="statusActive"
                                                value="1" {{ ($updateJob->status == 1 ) ? 'checked' : '' }}>
                                        ...
                                        <div class="form-check-inline">
                                            <input class="form-check-input" type="radio" name="status"
                                                id="statusBlock" value="0" {{ ($updateJob->status == 0) ? 'checked' : '' }}>
                                            <label class="form-check-label" for="statusBlock">
                                                Block
                                            </label>
                                        </div>
                                    </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea class="form-control editor" name="description" id="description" cols="5" rows="5"
                                        placeholder="Description">{{ $updateJob->description }}</textarea>
                                    <p class="text-danger"></p>
                                </div>
                                <div class="mb-4">
                                    <label for="benefits" class="mb-2">Benefits</label>
                                    <textarea class="form-control editor" name="benefits" id="benefits" cols="5" rows="5"
                                        placeholder="Benefits">{{ $updateJob->benefits }}</textarea>
                                </div>
                                <div class="mb-4">
                                    ...
                                    <textarea class="form-control editor" name="responsibility" id="responsibility" cols="5" rows="5"
                                        placeholder="Responsibility">{{ $updateJob->responsibility }}</textarea>
                                </div>
                                <div class="mb-4">
                                    <label for="qualifications" class="mb-2">Qualifications</label>
                                    <textarea class="form-control editor" name="qualifications" id="qualifications" cols="5" rows="5"
                                        placeholder="Qualifications">{{ $updateJob->qualifications }}</textarea>
                                </div>
                                <div class="row">
                                    <div class="col-md-12 mb-4">
                                        ...
                                        <select class="form-select" name="experience" id="experience">
                                            <option value="1" {{ $updateJob->experience == 1 ? 'selected' : '' }}>1
                                                Year</option>
                                            <option value="2" {{ $updateJob->experience == 2 ? 'selected' : '' }}>2
                                                Years</option>
                                            <option value="3" {{ $updateJob->experience == 3 ? 'selected' : '' }}>3
                                                Years</option>
                                            <option value="4" {{ $updateJob->experience == 4 ? 'selected' : '' }}>4
                                                Years</option>
                                            <option value="5" {{ $updateJob->experience == 5 ? 'selected' : '' }}>5
                                                Years</option>
                                            <option value="6" {{ $updateJob->experience == 6 ? 'selected' : '' }}>6
                                                Years</option>
                                            <option value="7" {{ $updateJob->experience == 7 ? 'selected' : '' }}>7
                                                Years</option>
                                            <option value="8" {{ $updateJob->experience == 8 ? 'selected' : '' }}>8
                                                Years</option>
                                            <option value="9" {{ $updateJob->experience == 9 ? 'selected' : '' }}>9
                                                Years</option>
                                            <option value="10" {{ $updateJob->experience == 10 ? 'selected' : '' }}>
                                                10+ Years</option>
                                        </select>
                                        <p></p>
                                    </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" placeholder="keywords" id="keywords" name="keywords"
                                        class="form-control" value="{{ $updateJob->keywords }}">
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="mb-4 col-md-6">
                                        ...
                                        <input type="text" placeholder="Location" id="company_location"
                                            ...
                                            value="{{ $updateJob->company_location }}">
                                    </div>
                                </div>
                                <div class="mb-4">
                                    <label for="website" class="mb-2">Website</label>
                                    <input type="text" placeholder="Website" id="website" name="website"
                                        class="form-control" value="{{ $updateJob->company_website }}">
                                </div>
                            </div>
...
@push('scripts')
    <script>
        ...
        $("#editJobForm").submit(function(e) {
            ...
            $.ajax({
                url: '{{ route('admin.job.update', $updateJob->id) }}',
                type: 'PUT',
                dataType: 'json',
